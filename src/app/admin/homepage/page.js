...
export default function HomepageEditor() {
  ...
  const fetchHomepageData = async () => {
    try {
      ...
      if (result.success) {
        ...
        setMessage({
          text: result.message || "Veriler alınamadı",
          type: "error",
        });
      }
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        setMessage({
          text: "Anasayfa içeriği başarıyla güncellendi",
          type: "success",
        });
      } else {
        setMessage({
          text: result.message || "İçerik güncellenemedi",
          type: "error",
        });
      }
    } catch (error) {
    ...
    <AdminLayout>
      ...
      <div className={styles.editorContainer}>
        <div className={styles.sectionTabs}>
          ...
          <button
            className={
              activeSection === "seo" ? styles.activeTab : styles.inactiveTab
            }
                ...
                <div className={styles.formGroup}>
                  ...
                  <div className={styles.inputGroup}>
                    ...
                    <FileUploader
                      ...
                      label="Görsel Yükle"
                      onUpload={(data) =>
                        handleInputChange("numbersSection", "image", data.url)
                      }
                    />
                  </div>
                </div>
                  ...
                  <div className={styles.languageTabs}>
                    <div className={styles.langTab}>
                      ...
                      <input
                        type="text"
                        value={
                          homepageData.servicesSection.buttonText?.tr || ""
                        }
                        onChange={(e) => {
                          const newValue = {
                    ...
                    <div className={styles.langTab}>
                      ...
                      <input
                        type="text"
                        value={
                          homepageData.servicesSection.buttonText?.en || ""
                        }
                        onChange={(e) => {
                          const newValue = {
                            ...(homepageData.servicesSection.buttonText || {}),
                    ...
                    <div className={styles.langTab}>
                      ...
                      <input
                        type="text"
                        value={
                          homepageData.servicesSection.buttonText?.de || ""
                        }
                        onChange={(e) => {
                          const newValue = {
                            ...(homepageData.servicesSection.buttonText || {}),
                    ...
                    <div className={styles.langTab}>
                      ...
                      <input
                        type="text"
                        value={
                          homepageData.servicesSection.buttonText?.ar || ""
                        }
                        onChange={(e) => {
                          const newValue = {
                            ...(homepageData.servicesSection.buttonText || {}),
                  ...
                  <div className={styles.languageTabs}>
                    <div className={styles.langTab}>
                      ...
                      <input
                        type="text"
                        value={
                          homepageData.projectsSection.buttonText?.tr || ""
                        }
                        onChange={(e) => {
                          const newValue = {
                    ...
                    <div className={styles.langTab}>
                      ...
                      <input
                        type="text"
                        value={
                          homepageData.projectsSection.buttonText?.en || ""
                        }
                        onChange={(e) => {
                          const newValue = {
                            ...(homepageData.projectsSection.buttonText || {}),
                    ...
                    <div className={styles.langTab}>
                      ...
                      <input
                        type="text"
                        value={
                          homepageData.projectsSection.buttonText?.de || ""
                        }
                        onChange={(e) => {
                          const newValue = {
                            ...(homepageData.projectsSection.buttonText || {}),
                    ...
                    <div className={styles.langTab}>
                      ...
                      <input
                        type="text"
                        value={
                          homepageData.projectsSection.buttonText?.ar || ""
                        }
                        onChange={(e) => {
                          const newValue = {
                            ...(homepageData.projectsSection.buttonText || {}),
                ...
                <div className={styles.formGroup}>
                  ...
                  <div className={styles.languageTabs}>
                    <div className={styles.langTab}>
                      ...
                      <textarea
                        value={
                          homepageData.contactSection.description?.tr || ""
                        }
                        onChange={(e) => {
                          const newValue = {
                    ...
                    <div className={styles.langTab}>
                      ...
                      <textarea
                        value={
                          homepageData.contactSection.description?.en || ""
                        }
                        onChange={(e) => {
                          const newValue = {
                            ...(homepageData.contactSection.description || {}),
                    ...
                    <div className={styles.langTab}>
                      ...
                      <textarea
                        value={
                          homepageData.contactSection.description?.de || ""
                        }
                        onChange={(e) => {
                          const newValue = {
                            ...(homepageData.contactSection.description || {}),
                    ...
                    <div className={styles.langTab}>
                      ...
                      <textarea
                        value={
                          homepageData.contactSection.description?.ar || ""
                        }
                        onChange={(e) => {
                          const newValue = {
                            ...(homepageData.contactSection.description || {}),
                ...
                <div className={styles.subSection}>
                    ...
                    <div className={styles.languageTabs}>
                      <div className={styles.langTab}>
                        ...
                        <input
                          type="text"
                          value={
                            homepageData.contactSection.phoneTitle?.tr || ""
                          }
                          onChange={(e) => {
                            const newValue = {
                      ...
                      <div className={styles.langTab}>
                        ...
                        <input
                          type="text"
                          value={
                            homepageData.contactSection.phoneTitle?.en || ""
                          }
                          onChange={(e) => {
                            const newValue = {
                              ...(homepageData.contactSection.phoneTitle || {}),
                      ...
                      <div className={styles.langTab}>
                        ...
                        <input
                          type="text"
                          value={
                            homepageData.contactSection.phoneTitle?.de || ""
                          }
                          onChange={(e) => {
                            const newValue = {
                              ...(homepageData.contactSection.phoneTitle || {}),
                      ...
                      <div className={styles.langTab}>
                        ...
                        <input
                          type="text"
                          value={
                            homepageData.contactSection.phoneTitle?.ar || ""
                          }
                          onChange={(e) => {
                            const newValue = {
                              ...(homepageData.contactSection.phoneTitle || {}),
                  ...
                  <div className={styles.arrayItems}>
                      ...
                      homepageData.contactSection.phones.map((phone, index) => (
                        <div className={styles.arrayItem} key={index}>
                          ...
                          <button
                            ...
                            onClick={() =>
                              removeArrayItem("contactSection", "phones", index)
                            }
                          >
                            Kaldır
                          </button>
                    ...
                    <button
                      ...
                      onClick={() =>
                        addArrayItem("contactSection", "phones", {
                          number: "",
                          link: "",
                        })
                      }
                ...
                <div className={styles.subSection}>
                    ...
                    <div className={styles.languageTabs}>
                      <div className={styles.langTab}>
                        ...
                        <input
                          type="text"
                          value={
                            homepageData.contactSection.emailTitle?.tr || ""
                          }
                          onChange={(e) => {
                            const newValue = {
                      ...
                      <div className={styles.langTab}>
                        ...
                        <input
                          type="text"
                          value={
                            homepageData.contactSection.emailTitle?.en || ""
                          }
                          onChange={(e) => {
                            const newValue = {
                              ...(homepageData.contactSection.emailTitle || {}),
                      ...
                      <div className={styles.langTab}>
                        ...
                        <input
                          type="text"
                          value={
                            homepageData.contactSection.emailTitle?.de || ""
                          }
                          onChange={(e) => {
                            const newValue = {
                              ...(homepageData.contactSection.emailTitle || {}),
                      ...
                      <div className={styles.langTab}>
                        ...
                        <input
                          type="text"
                          value={
                            homepageData.contactSection.emailTitle?.ar || ""
                          }
                          onChange={(e) => {
                            const newValue = {
                              ...(homepageData.contactSection.emailTitle || {}),
                  ...
                  <div className={styles.arrayItems}>
                      ...
                      homepageData.contactSection.emails.map((email, index) => (
                        <div className={styles.arrayItem} key={index}>
                          ...
                          <button
                            className={styles.removeItemButton}
                            onClick={() =>
                              removeArrayItem("contactSection", "emails", index)
                            }
                          >
                            Kaldır
                          </button>
                    ...
                    <button
                      className={styles.addItemButton}
                      onClick={() =>
                        addArrayItem("contactSection", "emails", {
                          address: "",
                          link: "",
                        })
                      }
