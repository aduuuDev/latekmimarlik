// NextAuth'u dinamik olarak import et

// Auth options factory
function createAuthOptions(CredentialsProvider) {
  return {
    providers: [
      CredentialsProvider({
      id: 'credentials',
...
try {
  ...
  handler = {
    GET: async () => new Response('Auth error', { status: 503 }),
    POST: async () => new Response('Auth error', { status: 503 })
  };
}
