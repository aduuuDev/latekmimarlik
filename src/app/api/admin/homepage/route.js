...
import {
  ...
  homepageSchema,
} from "@/utils/multiLanguageHelpers";
      ...
      homepage = {
        ...
        contactSection: {
          ...
          emails: [
            ...
            {
              address: "prague_arh@gmail.com",
              link: "mailto:prague_arh@gmail.com",
            },
          ],
        },
        seo: {
...
export async function PUT(request) {
  try {
    ...
    const homepageData = await createMultiLanguageDocument(
      data,
      homepageSchema
    );
    ...
    if (homepage) {
      ...
      await Homepage.findByIdAndUpdate(homepage._id, homepageData, {
        new: true,
        runValidators: true,
      });
    } else {
